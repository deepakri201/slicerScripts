...
# 
# To run on Mac: 
# /Applications/Slicer\ 4.app/Contents/MacOS/Slicer --python-script /Users/dk422/git/slicerScripts/abdomen_exp4/slicer_algorithm_comparison_compare_volumes.pyson.py
# 
# Deepa Krishnaswamy 
